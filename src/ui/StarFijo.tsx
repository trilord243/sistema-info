...
interface StarRatingProps {
  ...
  defRating?: number;
  fixedRating?: number; // Nueva propiedad para el rating fijo
}

export const StarFijo: React.FC<StarRatingProps> = ({
  maxRating = 5,
  ...
  const displayRating =
    fixedRating !== undefined ? fixedRating : tempRating || rating; // Usa el rating fijo si está definido
